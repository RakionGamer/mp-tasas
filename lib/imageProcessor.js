...
const baseImageUrl = 'https://res.cloudinary.com/dvh3nrsun/image/upload/v1755497438/A_venezuela_desde_uaxz4u.jpg';
...
export async function createImageWithRates(extractedData) {
    try {
        ...
        const tasasMapping = {
            chile: numeros.tasaChile || 'No disponible',
            peru: numeros.tasaPeru || 'No disponible',
            colombia: numberColombia || 'No disponible',
            argentina: numeros.tasaArgentina || 'Consultar',
            mexico: numeros.tasaMexico || 'No disponible',
            usa: numeros.tasaUSA || 'No disponible',
            panama: numeros.tasaPanama || 'No disponible',
            brasil: numeros.tasaBrasil || 'No disponible',
