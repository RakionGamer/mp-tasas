...
// --- NUEVO: Registrar la fuente antes de usarla ---
// 1. Crea una carpeta 'fonts' en la raíz de tu proyecto.
// 2. Descarga un archivo de fuente (ej. Arial, Roboto, etc.) y colócalo dentro.
//    Asegúrate de que el nombre del archivo coincida con el que se usa aquí ('Arial.ttf').
try {
...
export async function createImageWithRates(extractedData) {
    try {
        ...
        const drawTextWithStroke = (text, x, y, fontSize = 48, strokeWidth = 4) => {
            // Usamos la fuente 'Arial' que registramos previamente
