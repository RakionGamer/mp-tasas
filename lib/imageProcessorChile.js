...
const baseImageUrl = 'https://res.cloudinary.com/dvh3nrsun/image/upload/v1755497612/Dise-os-Multipower-Chile_uhabbi.jpg';

export async function createImageWithRatesChile(extractedData) {
    try {
        ...
        const numerosTasaUsa = numeros.tasaChileUSA + '÷';
        
        const tasasMapping = {
            peru: numeros.tasaChilePeru || 'No disponible',
            argentina: numeros.tasaChileArgentina || 'No disponible',
            mexico: numeros.tasaChileMexico || 'No disponible',
            brasil: numeros.tasaChileBrasil || 'No disponible',
            panama: numeros.tasaChilePanama || 'No disponible',
            colombia: numeros.tasaChileColombia || 'No disponible',
            españa: numeros.tasaChileEspaña || 'No disponible',
            ecuador: numeros.tasaChileEcuador || 'No disponible',
            usa: numerosTasaUsa || 'No disponible',
        };
