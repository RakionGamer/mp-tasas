...
const baseImageUrl = 'https://res.cloudinary.com/dvh3nrsun/image/upload/v1764989272/Dise%C3%B1os_MULTIPOWER_x5zfqq.png';
...
export async function createImageWithRatesChileVenezuela(extractedData) {
    try {
        ...
        if (extractedData.numeros) {
            // Datos de OCR (estructura normal)
            numeros = extractedData.numeros;
            // Asegurar que chile y pm estén disponibles desde extractedData
