...
const baseImageUrl = 'https://res.cloudinary.com/dvh3nrsun/image/upload/v1755497439/Desde_Venezuela_xselui.jpg';

export async function createImageWithRatesVenezuela(extractedData) {
    try {
        ...
        const tasasMapping = {
            peru: numeros.tasaVenezuelaPeru || 'No disponible',
            argentina: numeros.tasaVenezuelaArgentina || 'No disponible',
            brasil: numeros.tasaVenezuelaBrasil || 'No disponible',
            chile: numeros.tasaVenezuelaChile || 'No disponible',
            mexico: numeros.tasaVenezuelaMexico || 'No disponible',
            colombia: numeros.tasaVenezuelaColombia || 'No disponible',
            españa: numeros.tasaVenezuelaEspaña || 'No disponible',
            ecuador: numeros.tasaVenezuelaEcuador || 'No disponible',
        };
