...
const coordinates = {
  ...
  españa: { x: 1200, y: 675 },
  ecuador: { x: 1205, y: 871 },
  peru: { x: 1205, y: 1023 },
  usa: {x: 470, y: 1195 }
};

const baseImageUrl =
  "https://res.cloudinary.com/dvh3nrsun/image/upload/v1779927687/Dise%C3%B1os_MULTIPOWER_1_phtgiz.png";
  ...
  try {
    ...
    const tasasMapping = {
      ...
      argentina:
        ...
        "No disponible",
      brasil: extractedData?.tasaVenezuelaBrasil || dataVenezuela?.BRASIL || "Consultar",
      chile:
      ...
      ecuador:
        ...
        "No disponible",
      usa: extractedData?.tasaVenezuelaUSA || "No disponible",
    };
